...
import 'notificcc_model.dart';
export 'notificcc_model.dart';

class NotificccWidget extends StatefulWidget {
  const NotificccWidget({
    super.key,
    this.time,
  });
  ...
  @override
  State<NotificccWidget> createState() => _NotificccWidgetState();
}

class _NotificccWidgetState extends State<NotificccWidget>
    with TickerProviderStateMixin {
  late NotificccModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotificccModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> notificccUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final notificccUsersRecord = notificccUsersRecordList.isNotEmpty
            ? notificccUsersRecordList.first
            : null;
                              ...
                              child: StreamBuilder<List<UsersRecord>>(
                                stream: queryUsersRecord(
                                  queryBuilder: (usersRecord) =>
                                      usersRecord.where(
                                    'uid',
                                    isNotEqualTo: notificccUsersRecord?.uid,
                                  ),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
