...
class HomeUserCopyWidget extends StatefulWidget {
  const HomeUserCopyWidget({super.key});

  @override
  State<HomeUserCopyWidget> createState() => _HomeUserCopyWidgetState();
}

class _HomeUserCopyWidgetState extends State<HomeUserCopyWidget> {
  late HomeUserCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeUserCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> homeUserCopyUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final homeUserCopyUsersRecord = homeUserCopyUsersRecordList.isNotEmpty
            ? homeUserCopyUsersRecordList.first
            : null;
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<FamilyRecord>(
                          stream: FamilyRecord.getDocument(
                              homeUserCopyUsersRecord!.familyName!),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                              return Center(
