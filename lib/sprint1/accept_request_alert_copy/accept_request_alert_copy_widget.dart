...
import 'accept_request_alert_copy_model.dart';
export 'accept_request_alert_copy_model.dart';

class AcceptRequestAlertCopyWidget extends StatefulWidget {
  const AcceptRequestAlertCopyWidget({
    super.key,
  ...
  @override
  State<AcceptRequestAlertCopyWidget> createState() =>
      _AcceptRequestAlertCopyWidgetState();
}

class _AcceptRequestAlertCopyWidgetState
    extends State<AcceptRequestAlertCopyWidget> {
  late AcceptRequestAlertCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcceptRequestAlertCopyModel());
  }
