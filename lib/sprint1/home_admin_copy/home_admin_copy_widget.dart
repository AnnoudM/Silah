...
class HomeAdminCopyWidget extends StatefulWidget {
  const HomeAdminCopyWidget({super.key});

  @override
  State<HomeAdminCopyWidget> createState() => _HomeAdminCopyWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> homeAdminCopyUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final homeAdminCopyUsersRecord = homeAdminCopyUsersRecordList.isNotEmpty
            ? homeAdminCopyUsersRecordList.first
            : null;
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<FamilyRecord>(
                          stream: FamilyRecord.getDocument(
                              homeAdminCopyUsersRecord!.familyName!),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                            if (!snapshot.hasData) {
                              return Center(
