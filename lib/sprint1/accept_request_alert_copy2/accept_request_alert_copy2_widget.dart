...
import 'accept_request_alert_copy2_model.dart';
export 'accept_request_alert_copy2_model.dart';

class AcceptRequestAlertCopy2Widget extends StatefulWidget {
  const AcceptRequestAlertCopy2Widget({
    super.key,
  ...
  @override
  State<AcceptRequestAlertCopy2Widget> createState() =>
      _AcceptRequestAlertCopy2WidgetState();
}

class _AcceptRequestAlertCopy2WidgetState
    extends State<AcceptRequestAlertCopy2Widget> {
  late AcceptRequestAlertCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcceptRequestAlertCopy2Model());
  }
                                    ...
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          if ((_model.nameEx?.name ==
                                                  widget.accFirstname) &&
                                              (_model.nameEx?.familyid ==
                                                  columnUsersRecord
                                                      .familyName)) {
                                            await _model.nameEx!.reference
                                                .update({
                                              ...mapToFirestore(
                                                {
                                                  'count':
                                            ...
                                            await AnalyticsRecord.collection
                                                .doc()
                                                .set(createAnalyticsRecordData(
                                                  name: widget.accFirstname,
                                                  count: 1,
                                                  familyid: columnUsersRecord
                                                      .familyName,
                                                ));
                                          }

                                          if (widget.acceptedGender == 'ذكر') {
                                            ...
                                            await columnUsersRecord.familyName!
                                                .update({
                                              ...mapToFirestore(
                                                {
                                                  'girls':
