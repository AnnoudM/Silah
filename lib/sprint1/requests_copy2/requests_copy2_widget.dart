...
import 'requests_copy2_model.dart';
export 'requests_copy2_model.dart';

class RequestsCopy2Widget extends StatefulWidget {
  const RequestsCopy2Widget({super.key});

  @override
  State<RequestsCopy2Widget> createState() => _RequestsCopy2WidgetState();
}

class _RequestsCopy2WidgetState extends State<RequestsCopy2Widget> {
  late RequestsCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestsCopy2Model());
  }
