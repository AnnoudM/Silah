...
class SideAdminCopyWidget extends StatefulWidget {
  const SideAdminCopyWidget({super.key});

  @override
  State<SideAdminCopyWidget> createState() => _SideAdminCopyWidgetState();
}

class _SideAdminCopyWidgetState extends State<SideAdminCopyWidget> {
  late SideAdminCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SideAdminCopyModel());
  }
