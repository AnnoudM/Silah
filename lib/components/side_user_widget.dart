...
import 'side_user_model.dart';
export 'side_user_model.dart';

class SideUserWidget extends StatefulWidget {
  const SideUserWidget({super.key});

  @override
  State<SideUserWidget> createState() => _SideUserWidgetState();
}

class _SideUserWidgetState extends State<SideUserWidget> {
  late SideUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SideUserModel());
  }
