                                                                ...
                                                                queryBuilder:
                                                                    (usersRecord) =>
                                                                        usersRecord
                                                                            .where(
                                                                              'FamilyName',
                                                                              isEqualTo: currentUserDocument?.familyName,
                                                                            )
                                                                            .where(
                                                                              'Accepted',
                                                                              isEqualTo: true,
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  40.0),
                                                      child: Text(
                                                        'أكثر أسماء أفراد الأسرة شيوعًا',
                                                        textAlign:
                                                            TextAlign.center,
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              ...
                                                                              child: Text(
                                                                                listViewAnalyticsRecord.count.toString(),
