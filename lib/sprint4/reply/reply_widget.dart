            ...
            child: Column(
              ...
              children: [
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    return TextFormField(
                                                      ...
                                                      decoration:
                                                        ...
                                                        hintText:
                                                            'Reply to ${textField3UsersRecord.fullName}',
                                                        hintStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelMedium
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(48.0, 0.0, 32.0, 0.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              var replyRecordReference =
                                  ReplyRecord.collection.doc();
                              await replyRecordReference.set({
                                ...createReplyRecordData(
                                  numLike: 0,
                                  numReply: 0,
                                  replyContent:
                                      _model.textField3TextController.text,
                                  replyPost: widget.postRef,
                                  replyUser: widget.userRef,
                                  replyTo: widget.userRef,
                                ),
                                ...mapToFirestore(
                                  {
                                    'time_replied':
                              ...
                              _model.output = ReplyRecord.getDocumentFromData({
                                ...createReplyRecordData(
                                  numLike: 0,
                                  numReply: 0,
                                  replyContent:
                                ...
                                ...mapToFirestore(
                                  {
                                    'Replied_By': FieldValue.arrayUnion(
                                        [widget.userRef]),
                                    'num_reply': FieldValue.increment(1),
                                    'postReply': FieldValue.arrayUnion(
