...
class _EditEventWidgetState extends State<EditEventWidget>
  ...
  void initState() {
    ...
    _model.eventDesTextController ??=
        TextEditingController(text: widget.event?.eventDes);
    _model.eventDesFocusNode ??= FocusNode();

    _model.locTextController ??=
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.eventDesTextController,
                                            focusNode: _model.eventDesFocusNode,
                                            textCapitalization:
                                            ...
                                            validator: _model
                                                .eventDesTextControllerValidator
                                                .asValidator(context),
                                          ),
                                        ),
                                      ),
