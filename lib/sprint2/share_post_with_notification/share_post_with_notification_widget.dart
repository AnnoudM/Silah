...
class SharePostWithNotificationWidget extends StatefulWidget {
  ...
  @override
  State<SharePostWithNotificationWidget> createState() =>
      _SharePostWithNotificationWidgetState();
}

class _SharePostWithNotificationWidgetState
    extends State<SharePostWithNotificationWidget> {
  late SharePostWithNotificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SharePostWithNotificationModel());
