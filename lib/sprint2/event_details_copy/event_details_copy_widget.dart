  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<EventsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<EventsRecord> eventDetailsCopyEventsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final eventDetailsCopyEventsRecord =
            eventDetailsCopyEventsRecordList.isNotEmpty
                ? eventDetailsCopyEventsRecordList.first
                : null;
