...
export 'directory_page_copy_model.dart';

class DirectoryPageCopyWidget extends StatefulWidget {
  const DirectoryPageCopyWidget({
    super.key,
    this.currentpage,
  });
  ...
  @override
  State<DirectoryPageCopyWidget> createState() =>
      _DirectoryPageCopyWidgetState();
}

class _DirectoryPageCopyWidgetState extends State<DirectoryPageCopyWidget>
    with TickerProviderStateMixin {
  late DirectoryPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DirectoryPageCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> directoryPageCopyUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final directoryPageCopyUsersRecord =
            directoryPageCopyUsersRecordList.isNotEmpty
                ? directoryPageCopyUsersRecordList.first
                : null;
