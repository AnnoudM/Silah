...
class SharePostCopyWidget extends StatefulWidget {
  const SharePostCopyWidget({
    super.key,
    this.parameter1,
  });
  ...
  @override
  State<SharePostCopyWidget> createState() => _SharePostCopyWidgetState();
}

class _SharePostCopyWidgetState extends State<SharePostCopyWidget> {
  late SharePostCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SharePostCopyModel());
