...
import 'calender_page_copy_model.dart';
export 'calender_page_copy_model.dart';

class CalenderPageCopyWidget extends StatefulWidget {
  ///
  const CalenderPageCopyWidget({
    super.key,
    this.famName,
    this.currentPage,
  });
  ...
  @override
  State<CalenderPageCopyWidget> createState() => _CalenderPageCopyWidgetState();
}

class _CalenderPageCopyWidgetState extends State<CalenderPageCopyWidget>
    with TickerProviderStateMixin {
  late CalenderPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CalenderPageCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> calenderPageCopyUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final calenderPageCopyUsersRecord =
            calenderPageCopyUsersRecordList.isNotEmpty
                ? calenderPageCopyUsersRecordList.first
                : null;
                                                    ...
                                                    builder:
                                                      ...
                                                      return ListView.builder(
                                                        ...
                                                        itemBuilder: (context,
                                                          ...
                                                          return EventWidget(
                                                            key: Key(
                                                                'Keyzec_${listViewIndex}_of_${listViewEventsRecordList.length}'),
                                                            eventRef:
                                                    ...
                                                    builder:
                                                      ...
                                                      return ListView.builder(
                                                        ...
                                                        itemBuilder: (context,
                                                          ...
                                                          return EventWidget(
                                                            key: Key(
                                                                'Keycor_${listViewIndex}_of_${listViewEventsRecordList.length}'),
                                                            eventRef:
                                                                listViewEventsRecord
                                                                    .reference,
                                                          );
                                                    ...
                                                    builder:
                                                      ...
                                                      return ListView.builder(
                                                        ...
                                                        itemBuilder: (context,
                                                          ...
                                                          return EventWidget(
                                                            key: Key(
                                                                'Keygas_${listViewIndex}_of_${listViewEventsRecordList.length}'),
                                                            eventRef:
                                                                listViewEventsRecord
                                                                    .reference,
                                                          );
                                                    ...
                                                    builder:
                                                      ...
                                                      return ListView.builder(
                                                        ...
                                                        itemBuilder: (context,
                                                          ...
                                                          return EventWidget(
                                                            key: Key(
                                                                'Key0ue_${listViewIndex}_of_${listViewEventsRecordList.length}'),
                                                            eventRef:
                                                                listViewEventsRecord
                                                                    .reference,
                                                          );
