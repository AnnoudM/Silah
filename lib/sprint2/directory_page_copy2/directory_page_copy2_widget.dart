...
export 'directory_page_copy2_model.dart';

class DirectoryPageCopy2Widget extends StatefulWidget {
  const DirectoryPageCopy2Widget({
    super.key,
    this.currentpage,
  });
  ...
  @override
  State<DirectoryPageCopy2Widget> createState() =>
      _DirectoryPageCopy2WidgetState();
}

class _DirectoryPageCopy2WidgetState extends State<DirectoryPageCopy2Widget>
    with TickerProviderStateMixin {
  late DirectoryPageCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DirectoryPageCopy2Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> directoryPageCopy2UsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final directoryPageCopy2UsersRecord =
            directoryPageCopy2UsersRecordList.isNotEmpty
                ? directoryPageCopy2UsersRecordList.first
                : null;
