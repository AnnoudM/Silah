...
import 'posts_copy2_model.dart';
export 'posts_copy2_model.dart';

class PostsCopy2Widget extends StatefulWidget {
  const PostsCopy2Widget({
    super.key,
    this.currentpage,
  });
  ...
  @override
  State<PostsCopy2Widget> createState() => _PostsCopy2WidgetState();
}

class _PostsCopy2WidgetState extends State<PostsCopy2Widget>
    with TickerProviderStateMixin {
  late PostsCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostsCopy2Model());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> postsCopy2UsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final postsCopy2UsersRecord = postsCopy2UsersRecordList.isNotEmpty
            ? postsCopy2UsersRecordList.first
            : null;
                                                              ...
                                                              queryBuilder: (postsRecord) =>
                                                                  postsRecord
                                                                      .where(
                                                                        'FamilyID',
                                                                        isEqualTo:
                                                                            postsCopy2UsersRecord?.familyName,
                                                                      )
                                                                      .orderBy(
                                                                          'DatePosted',
                                                                          descending:
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return InkWell(
                                                                          ...
                                                                          child:
                                                                              PostitemsWidget(
                                                                            key:
                                                                                Key('Keyh4j_${mainListIndex}_of_${mainListPostsRecordList.length}'),
                                                                            userRef:
                                                                                postitemsaUsersRecord.reference,
                                                                            postRef:
                                                                                mainListPostsRecord.reference,
                                                                    ...
                                                                    return StreamBuilder<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return PostitemsWidget(
                                                                          key: Key(
                                                                              'Keyikh_${mainListIndex}_of_${mainListPostsRecordList.length}'),
                                                                          userRef:
                                                                              postitemsaUsersRecord.reference,
                                                                          postRef:
                                                                              mainListPostsRecord.reference,
